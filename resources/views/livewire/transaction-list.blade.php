            ...
            <tbody>
                @forelse ($transaction as $item)
                    <tr class="border-b dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <td class="px-4 py-3"> {!! getStatusBadge($item->tahap) !!}</td>
                        ...
                        <td class="px-4 py-3">
                            ...
                            <button data-modal-target="default-modal-{{$loop->iteration}}" data-modal-toggle="default-modal-{{$loop->iteration}}"
                                    ...
                                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                        ...
                                        <div
                                            ...
                                            <div class="px-4 sm:px-0">
                                                <h3 class="text-base font-semibold leading-7 text-gray-900">Applicant
                                                    Information</h3>
                                        ...
                                        <!-- Modal footer -->
                                        <x-transaction-action :status="$item->tahap" />
                                    </div>
                                </div>
                            </div>
                        </td>
