    ...
    @if ($type == 'all')
        <div class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
            <div class="w-full flex items-center gap-2">
                ...
                <a href="{{ route('trans.export') }}"
                    class="block bg-green-600 hover:bg-green-700 focus:ring-4 focus:outline-none focus:ring-green-500  text-white font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800s">Export</a>
            </div>
        ...
        <table class="w-full text-sm text-left text-gray-500 ">
            <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                <tr>
                    ...
                    <th scope="col" class="px-4 py-3 text-center" colspan="{{ $type == 'all' ? '2' : '1' }}">Data
                        Kendaraan
                    </th>
